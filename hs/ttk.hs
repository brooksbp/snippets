...
{- build a circular, doubly-linked list given a standard list. since haskell
   is lazy, you can set the children to the final value instantly even
   though you don't know them yet! -}
